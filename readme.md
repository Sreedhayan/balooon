...
Simply open `baloon.html` in any modern browser. No build step or server required.
...
```bash
# Serve locally (optional, works without server too)
python3 -m http.server 8080
```

## Authors

- [Sreedhayan](https://github.com/Sreedhayan)
- [cosmicnerd-grb](https://github.com/cosmicnerd-grb)
